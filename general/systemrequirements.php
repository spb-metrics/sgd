...
$block1 = new block();
$block1->heading("SGD : ".$strings["requirements"]);
...
$block2 = new block();
$block2->heading("SGD : Quick Start");

$block2->openContent();
$block2->contentTitle("Introduction");

$block2->contentRow("1-","SGD is a project management system. It is comprised of two interfaces:");
...
$block2->contentRow("2-","When a client first logs into SGD they are presented with a <b>Home</b> page that shows all projects that have been created for them. Once a client selects a project they will have the following options:");
...
$block2->contentRow("1-","SGD is a fantastic program that can give you the tools necessary to manage all of your tasks and projects. However, there is one misconception.");
$block2->contentRow("a","SGD does not publish your web site. SGD manages your projects, not your web site.");
$block2->closeContent(); 
