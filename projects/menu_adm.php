...
if ($profilSession == "0" || $profilSession == "10" || $profilSession == "9" || $profilSession == "7" || $profilSession == "6"){

echo '<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="1%">&nbsp;</td>';
      echo "<td width=\"21%\"><a href='../projects/listprojects.php?&".session_name()."=".session_id()."'>Demandas</a></td>";
      echo '<td width="21%">Relat&oacute;rio</td>
      <td width="21%">Administra&ccedil;&atilde;o</td>';
