...
if ($action == "add") {
	...
	if (!ereg("([A-Z,a-z,0-9]+)", trim($_FILES['mes']['name']))) {
		echo "<script>alert('Arquivo fora do padrão, Retire Caracteres de Acentuação, " . $_FILES['mes']['name'] . " !');history.back();</script>";
		exit;
	}

	if (!preg_match('/^(.*)\.(doc)$/', $_FILES['mes']['name'])) {
		echo "<script>alert('Arquivo fora do padrão, Somente é possivel salvar arquivo do WORD, " . $_FILES['mes']['name'] . " !');history.back();</script>";
		exit;
	}
	...
	if ($_FILES['mes']['name'] != "") {
		...
		$up = $diretorio . basename(retira_ac(trim($_FILES['mes']['name'])));
	...
	$tmpquery1 = "INSERT INTO " . $tableCollab["projects_corretiva"] . " (descricao,erro,id_projeto) VALUES('$tit','$up','$pro')";

	connectSql("$tmpquery1");
	echo '<script>alert("Registrado com Sucesso!");</script>';
	echo '<script>window.location.href="viewproject.php?id=' . $pro . '&' . session_name() . "=" . session_id() . '";</script>';
	exit;
}
...
$block1 = new block();
$block1->openForm("../projects/adderro.php?" . session_name() . "=" . session_id() . "&action=add&project=$project#filedetailsAnchor","addsupport","onSubmit=\"return verifica_campo();\"");
$block1->heading($strings["info_erro"]);
...
$block1->openRow("on");
$block1->cellRow("<strong style= color:'red';>".$strings["demanda"]."</strong>","","","","3","");
$block1->closeRow();

$block1->openRow();
$block1->cellRow("".$strings["num_demanda"]."","","","","","1");
$block1->cellRow("","","","","","3");
$block1->cellRow("".$projectDetail->pro_id[0]."","","","","","");
$block1->closeRow();

$block1->openRow();
$block1->cellRow("" . $strings["sistema"] . "","","","","","1");
$block1->cellRow("","","","","","3");
$block1->cellRow("" . $system . "","","","","","");
$block1->closeRow();

$block1->openRow();
$block1->cellRow("" . $strings["t_demanda"] . "","","","","","1");
$block1->cellRow("","","","","","3");
$block1->cellRow("" . $projectDetail->pro_name[0] . "","","","","","");
$block1->closeRow();

$block1->openRow();
$block1->cellRow("" . $strings["status"] . "","","","","","1");
$block1->cellRow("","","","","","3");
$block1->cellRow("" . $status[$idStatus] . "","","","","","");
$block1->closeRow();

$block1->openRow();
$block1->cellRow("" . $strings["date_open"] . "","","","","","1");
$block1->cellRow("","","","","","3");
$block1->cellRow("" . nl2br(invert_data($projectDetail->pro_created[0])) . "","","","","","");
$block1->closeRow();

$block1->openRow();
$block1->cellRow("" . $strings["priority"] . "","","","","","1");
$block1->cellRow("","","","","","3");
$block1->cellRow("" . $priority[$idPriority] . "","","","","","");
$block1->closeRow();

$block1->openRow();
$block1->cellRow("" . $strings["uni_adm"] . "","","","","","1");
$block1->cellRow("","","","","","3");
$block1->cellRow("" . $nome_unidade . "","","","","","");
$block1->closeRow();

$block1->openRow();
$block1->cellRow("" . $strings["nome_gestor"] . "","","","","","1");
$block1->cellRow("","","","","","3");
$block1->cellRow("" . $nome_gestor . "","","","","","");
$block1->closeRow();
...
$block1->openRow();
$block1->cellRow("" . $strings["analista_relacionamento_permissions"] . "","","","","","1");
$block1->cellRow("","","","","","3");
$block1->cellRow("".$nome_analita."","","","","","");
$block1->closeRow();

$block1->openRow();
$block1->cellRow("" . $strings["project_manager_permissions"] . "","","","","","1");
$block1->cellRow("","","","","","3");
$block1->cellRow("".$nome_g_pro."","","","","","");
$block1->closeRow();
...
$block1->openContent("90%","","","2","","","");

$block1->openRow("on");
$block1->cellRow("<strong style= color:'red';>".$strings["info_arquivo"]."</strong>","","","","3","");
$block1->closeRow();

$block1->openRow("on");
$block1->cellRow("".$strings["titulo"]."</strong>","","","","","");
$block1->cellRow("<input size=\"32\" value=\"$tit\" style=\"width: 400px\" name=\"tit\" maxlength=\"32\" type=\"text\">","","","","","");
$block1->closeRow();

$block1->openRow("on");
$block1->cellRow("".$strings["arquivo"]."</strong>","","","","","");
$block1->cellRow("<input size=\"32\" value=\"$tit\" style=\"width: 400px\" name=\"mes\" maxlength=\"32\" type=\"file\"><img src=\"../themes/".THEME."/seta.gif\" width=\"20\" height=\"20\" align=\"top\"><span> Informe arquivo do <strong>WORD</strong>.</span>","","","","","");
$block1->closeRow();

echo "<input type=\"hidden\" name=\"user\" value=\"$idSession\">" .
	 "<input type=\"hidden\" name=\"pro\" value=\"" . $project . "\">" .
 	 "<input type=\"hidden\" name=\"titpro\" value=\"" . $projectDetail->pro_name[0]."\">";
		
$block1->openRow("on");
$block1->cellRow("&nbsp","","","","","");
$block1->cellRow("<input type=\"submit\" value=\"" . $strings["submit"] . "\">","","","","","");
$block1->closeRow();
