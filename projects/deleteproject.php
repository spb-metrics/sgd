...
if ($idSession != $listProjects->pro_owner[0] && $profilSession != 6) {
...
//if CVS repository enabled
	...
	$tmpquery12 = "DELETE FROM ".$tableCollab["ata_reuniao"]." WHERE id_projeto IN($id)";
	$tmpquery13 = "DELETE FROM ".$tableCollab["solicita_mudanca"]." WHERE id_projeto IN($id)";
	$tmpquery14 = "DELETE FROM ".$tableCollab["calendar"]." WHERE id_project IN($id)";
	$tmpquery15 = "DELETE FROM ".$tableCollab["fases"]." WHERE id_projeto IN($id)";
	$tmpquery16 = "DELETE FROM ".$tableCollab["fase_pedente"]." WHERE id_projeto IN($id)";
	$tmpquery17 = "DELETE FROM ".MYDATABASE.".projects_corretiva WHERE id_projeto IN($id)";
	$tmpquery18 = "DELETE FROM ".$tableCollab["termo_aceite"]." WHERE id_projeto IN($id)";
		
	connectSql($tmpquery18);
	connectSql($tmpquery17); 
	connectSql($tmpquery16);
	connectSql($tmpquery15);
	connectSql($tmpquery14);
	connectSql($tmpquery13);
