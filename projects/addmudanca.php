...
if ($action == "add") {
	...
	$tmpquery1 = "INSERT INTO " . $tableCollab["solicita_mudanca"] . "(titulo,descricao,data,id_projeto,id_usuario) VALUES('$tit','$mes','" . date('Y-m-d') . "','$project','$idSession')";
	connectSql($tmpquery1);

	headerFunction("viewproject.php?id=$project&" . session_name() . "=" . session_id());
	exit;
}
...
$block1->openForm("addmudanca.php?" . session_name() . "=" . session_id() . "&action=add&project=$project#filedetailsAnchor","addsupport","onSubmit=\"return verifica_campo();\"");
$block1->heading($strings["so_mudanca"]);
...
$block1->openRow("on");
$block1->cellRow("<strong style= color:'red';>".$strings["smudanca"]."</strong>","","","","3","");
$block1->closeRow();

$block1->openRow("on");
$block1->cellRow("".$strings["titulo"]."","","","","","");
$block1->cellRow("<input size=\"32\" value=\"$tit\" style=\"width: 400px\" name=\"tit\" maxlength=\"32\" type=\"text\">","","","","","");
$block1->closeRow();

$block1->openRow("on");
$block1->cellRow("".$strings["message"]."","","","","","");
$block1->cellRow("<textarea rows=\"3\" style=\"width: 400px; height: 50px;\" name=\"mes\" cols=\"43\">$mes</textarea>","","","","","");
$block1->closeRow();
