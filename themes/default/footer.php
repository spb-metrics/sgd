...
echo "<p id=\"footer\">SGD v1.0";

if ($notLogged != "true" && $blank != "true") {
echo " - Usuários Conectados: $connectedUsers";
}
...
echo '</table><tr bgcolor="#006699">
    <td colspan="3" align="center"><span  style="color:#FFFFFF ">FNDE 2006 - Fundo Nacional de Desenvolvimento da Educação</span></td>
  </tr>';
 
$blockHeader->closeTable();
//$blockPage->closeTable();
echo "<map name=\"Map\">
  <area shape=\"rect\" coords=\"523,9,567,27\" href=\"#\" alt=\"Ajuda\">
  <area shape=\"rect\" coords=\"574,10,659,27\" href=\"mailto:CGETI_Relacionamento@fnde.gov.br\" alt=\"Sítio da intranet do FNDE\">
  <area shape=\"rect\" coords=\"666,9,752,27\" href=\"http://www.fnde.gov.br/\" alt=\"Sítio da internet do FNDE\">
</map>";
echo "	</p>\n\n
		</body>
		</html>
