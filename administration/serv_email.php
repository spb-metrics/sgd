...
if($rmdt!=""){
	...
	headerFunction("../administration/serv_email.php?mailData=".$dataver."&".session_name()."=".session_id());
	exit;
...
$block1->openContent();
$block1->contentTitle($strings["mail_management"]);
if($borne1==""){
$borne1 = 0;
} 
				...
				if($controD->sco_data[$i] != $controD->sco_data[$i-1]){
					if(($conv>=$borne1)&&($conv < $vald)){
						...
						//$block1->contentRow("",$blockPage->buildLink("../users/listusers.php?",invert_data($controD->sco_data[$i])."-".$controD->sco_processo[$i],in));
							$block1->openRow();
							$block1->cellRow("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$blockPage->buildLink("../administration/serv_email.php?mailData=".$controD->sco_data[$i]."",invert_data($controD->sco_data[$i]),in),'80%');
							//$block1->contentRow("",$blockPage->buildLink("../administration/serv_email.php?mailData=".$controD->sco_data[$i]."",invert_data($controD->sco_data[$i]),in));
							$block1->cellRow($blockPage->buildLink("../administration/serv_email.php?rmdt=".$controD->sco_data[$i]."&rmlog=ok&rmid=".$controD->sco_id[$i]."","Remover",in),'20%');
							$block1->closeRow();
...
if(!$mailData==""){
	...
	//echo "mostra".$controD->sco_id[$i];
		...
		if(($i>=$borne1)&&($i<$vald)){
			...
			//$block1->contentRow("",$blockPage->buildLink("../administration/serv_email.php?mailDetail=".$controD->sco_id[$i]."",invert_data($controD->sco_data[$i])."-".$controD->sco_processo[$i],in));
			
			$block1->openRow();
			//$block1->cellRow("",'10%');
			$block1->cellRow("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$blockPage->buildLink("../administration/serv_email.php?mailDetail=".$controD->sco_id[$i]."",invert_data($controD->sco_data[$i])."- Demanda:".$controD->sco_project[$i].", ".$controD->sco_processo[$i],in),'80%');
			$block1->cellRow($blockPage->buildLink("../administration/serv_email.php?rmlog=ok&rmid=".$controD->sco_id[$i]."","Remover",in),'20%');
			$block1->closeRow();
	     }
	++$conv;
	} //fim for;
...
if(!$mailDetail=="" && $mailData==""){
	...
	//echo "mostra".$controD->sco_id[$i];
	//$block1->contentRow("",$blockPage->buildLink("../users/listusers.php?",invert_data($controD->sco_data[$i])."-".$controD->sco_processo[$i],in));
	$block1->contentRow("",$blockPage->buildLink("../administration/serv_email.php?mailDetail=".$controD->sco_id[$i]."",invert_data($controD->sco_data[$i]),in));
	$block1->contentRow("",$blockPage->buildLink("../administration/serv_email.php?mailDetail=".$controD->sco_id[$i]."","DEMANDA:".$controD->sco_project[$i]."-SITUAÇÃO:".$controD->sco_processo[$i],in));
	$gera = new arquivo();
