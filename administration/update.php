...
$nomesis = $_REQUEST['nosis2'];
$sgsistema = $_REQUEST['sisgs'];
$id_usu = $_REQUEST['id_usu'];
$id_sis = $_REQUEST['id_sis'];
include('../includes/library.php');

  if($sgsistema != "" AND $id_usu != ""){
     $tmp_sistema = " UPDATE SGD_FNDE.SISTEMAS SET NO_SISTEMA = '".strtoupper(trim($nomesis))."', CO_SISTEMA = '".strtoupper(trim($sgsistema))."' WHERE ID = '".$id_sis."'";
     ...
     echo"<br>";
     echo " <a href =\"Formgest.php?gsst='.$id_usu.'\">voltar</a>";
  } 
?>    