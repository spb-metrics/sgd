...
include('../includes/library.php');
 ...
 $localizacaoatualizada = $_REQUEST['unigs'];
 $telatualizado = $_REQUEST['tel2'];

  if($telatualizado != "" OR $localizacaoatualizada != ""){
     $tmp_organization = "UPDATE ".MYDATABASE.".MEMBERS SET ORGANIZATION = '".$localizacaoatualizada."', PHONE_WORK = '".$telatualizado."' WHERE ID = '".$id_usu."'";
     connectSql("$tmp_organization");
   
     echo "<script> alert('Atualização Realizada!!');</script>";
     header('Location:Formcoord.php?id_usu='.$id_usu.'&tipo_usu='.$tipousu.'');
   }
  
$tmp_usuario = " AND SU.id = '" . $id_usu . "'  ";
$sel_Usuario = new request();
$sel_Usuario->openAplicacao($tmp_usuario);
$contUsuario = count($sel_Usuario->apl_id);
...
$block1->contentTitle("Alterar", "5");

$block1->openForm("../administration/FormAltcoord.php", "formAlt");	

$insNome = $block1->insInput("nome", "nome", "70", "",$sel_Usuario->apl_nome[0], "", "17", "");
$insidusu = $block1->insInput("id_usu", "id_usu", "50", "", $id_usu, "", "17", "", "2");
$instipousu = $block1->insInput("tipousu", "tipousu", "50", "", $tipo_usu, "", "17", "", "2");

$block1->openRow("on");
$block1->cellRow($insidusu."&nbsp;".$instipousu, "1%", "", "", "0");
$block1->cellRow("Nome:", "15%", "", "", "0", "0");
$block1->cellRow($insNome, "83%", "", "", "2", "1");
$block1->cellRow("&nbsp;", "1%", "", "", "0");
$block1->closeRow();

$insEmail = $block1->insInput("emailgs", "emailgs", "70", "",$sel_Usuario->apl_email[0], "", "17", "");
...
$insLotacao = $block1->insInput("lotacaogs", "lotacaogs", "17", "",$sel_Usuario->apl_siglaunidade[0], "", "17", "disabled");
$option_unidade = array (
	0 => "0",
	1 => "<strong>Selecione Unidade</strong>"
);
$insLocalizacao = $block1->insSelect($sel_Organization->org_id, $sel_Organization->org_name,$sel_Usuario->apl_idunidade[0], "unigs", "unigs", "", $option_unidade, "", "17", "");
...
$block1->cellRow("Localização:" . $insLocalizacao, "50%", "", "", "2");
$block1->closeRow();

$insTelefone = $block1->insInput("tel", "tel", "17", "",$sel_Usuario->apl_telefone[0], "", "17", "disabled");
$insTelefoneatual = $block1->insInput("tel2", "tel2", "17", "",$sel_Usuario->apl_telefone[0], "", "17", "");
...
$insButton = $block1->insButton("1", "SUBMIT", "SUBMIT", "", "", "Alterar", "", "", "");

$block1->openRow("on");
$block1->cellRow($insButton . "&nbsp;&nbsp;<a href='Formcoord.php?id_usu=" . $id_usu . "&tipo_usu=".$tipo_usu."'>| Voltar |</a> ", "80%", "", "", "5", "2");
$block1->closeRow();
