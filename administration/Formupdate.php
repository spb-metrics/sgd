...
$nomesis = $_REQUEST['no_sis'];
$sgsistema = $_REQUEST['sg_sis'];
$id_usu = $_REQUEST['id_usu'];
$id_sis = $_REQUEST['id_sis'];

include_once ("../themes/default/header_window.php");

$block1 = new block();
$block1->heading("Gerenciamento de Sistema");
$block1->openContent();
$block1->contentTitle("Alterar Sistema", "5");
$block1->openForm("../administration/update.php", "form1");

$insSis = $block1->insInput("id_sis", "id_sis", "70", "", $id_sis, "", "17", "", "2");
$insidusu = $block1->insInput("id_usu", "id_usu", "50", "", $id_usu, "", "17", "", "2");
$insSigla = $block1->insInput("sisgs", "sisgs", "20", "", $sgsistema, "", "17", "");

$block1->openRow("on");
$block1->cellRow($insidusu . "&nbsp;" . $insSis, "1%", "", "", "0");
$block1->cellRow("Sigla do Sistema:", "25%", "", "", "0", "0");
$block1->cellRow($insSigla, "73%", "", "", "2", "1");
$block1->cellRow("&nbsp;", "1%", "", "", "0");
$block1->closeRow();

$insNome = $block1->insInput("nosis2", "nosis2", "50", "", $nomesis, "", "17", "");

$block1->openRow("on");
$block1->cellRow($insidusu . "&nbsp;" . $insSis, "1%", "", "", "0");
$block1->cellRow("Nome (Sistema):", "25%", "", "", "0", "0");
$block1->cellRow($insNome, "73%", "", "", "2", "1");
$block1->cellRow("&nbsp;", "1%", "", "", "0");
$block1->closeRow();
