...
if (!$profilSession == 6 && !$profilSession == 0) 
{
...
//INI QTD DE GESTOR
	$tmp_Guser = " AND SG.NO_GRUPO IN('sgd_gestor') ";
	
	$all_Gusers = new  request();
	$all_Gusers->openSousuario($tmp_Guser);
	$contGuser = count($all_Gusers->so_id);  
//FIM QTD DE GESTOR

//INI QTD COOR. DE RELACIONAMENTO
	$tmp_Auser = " AND SG.NO_GRUPO IN('sgd_coordenador_relacionamento') ";
	
	$all_Ausers = new  request();
	$all_Ausers->openSousuario($tmp_Auser);
	$contAuser = count($all_Ausers->so_id);  
//FIM QTD COOR. DE RELACIONAMENTO

//INI QTD COOR. DE FABRICA
	$tmp_Fuser = " AND SG.NO_GRUPO IN('sgd_coor_fabric') ";
	
	$all_Fusers = new  request();
	$all_Fusers->openSousuario($tmp_Fuser);
	$contFuser = count($all_Fusers->so_id);  
//FIM QTD COOR. DE FABRICA

//INI QTD GERENCIAL
	$tmp_GEuser = " AND SG.NO_GRUPO IN('sgd_coor_relat') ";
	
	$all_GEusers = new  request();
	$all_GEusers->openSousuario($tmp_GEuser);
	$contGEuser = count($all_GEusers->so_id);  
//FIM QTD GERENCIAL

//INI QTD CONSULTA
	$tmp_Uuser = " AND SG.NO_GRUPO IN('sgd_usuario') ";
	
	$all_Uusers = new  request();
	$all_Uusers->openSousuario($tmp_Uuser);
	$contUuser = count($all_Uusers->so_id);  
//FIM QTD CONSULTA

//INI QTD GERENTE PROJETO
	$tmp_GPuser = " AND SG.NO_GRUPO IN('sgd_gerente_projeto') ";
	
	$all_GPusers = new  request();
	$all_GPusers->openSousuario($tmp_GPuser);
	$contGPuser = count($all_GPusers->so_id);  
//FIM QTD GERENTE PROJETO

//INI QTD ANALISTA DE RELACIONAMENTO
	$tmp_ANuser = " AND SG.NO_GRUPO IN('sgd_analista_relat') ";
	
	$all_ANusers = new  request();
	$all_ANusers->openSousuario($tmp_ANuser);
	$contANuser = count($all_ANusers->so_id);  
//FIM QTD ANALISTA DE RELACIONAMENTO
...
$block1->arrayTitle($sortingFields = array(0=>"-",1=>"Nome:",2=>"Quantidade"),$widthFields = array(0=>"5%",1=>"55%",2=>"40%"));
$block1->openTablelist();


$block1->openRow("");
$block1->cellRow("",'5%',"", '25');
$block1->cellRow($blockPage->buildLink("gestor.php?tipo_usu=3&",$strings["ger_gest"],in),'60%',"", '25');
$block1->cellRow("<strong>".$contGuser."</strong>",'35%',"", '25');
$block1->closeRow();  


$block1->openRow("");
$block1->cellRow("",'5%',"", '25');
$block1->cellRow($blockPage->buildLink("coodrel.php?tipo_usu=6&",$strings["ger_coordrel"]."<br>",in),'60%',"", '25');
$block1->cellRow("<strong>".$contAuser."</strong>",'40%',"", '25');
$block1->closeRow();
...
$block1->openRow("");
$block1->cellRow("",'5%',"", '25');
$block1->cellRow($blockPage->buildLink("coodrel.php?tipo_usu=10&",$strings["ger_coordfab"]."<br>",in),'60%',"", '25');
$block1->cellRow("<strong>".$contFuser."</strong>",'40%',"", '25');
$block1->closeRow();


$block1->openRow("");
$block1->cellRow("",'5%',"", '25');
$block1->cellRow($blockPage->buildLink("coodrel.php?tipo_usu=8&",$strings["ger_ger"]."<br>",in),'60%',"", '25');
$block1->cellRow("<strong>".$contGEuser."</strong>",'40%',"", '25');
$block1->closeRow();


$block1->openRow("");
$block1->cellRow("",'5%',"", '25');
$block1->cellRow($blockPage->buildLink("coodrel.php?tipo_usu=11&",$strings["ger_consulta"]."<br>",in),'60%',"", '25');
$block1->cellRow("<strong>".$contUuser."</strong>",'40%',"", '25');
$block1->closeRow();


$block1->openRow("");
$block1->cellRow("",'5%',"", '25');
$block1->cellRow($blockPage->buildLink("coodrel.php?tipo_usu=1&",$strings["ger_gerproj"]."<br>",in),'60%',"", '25');
$block1->cellRow("<strong>".$contGPuser."</strong>",'40%',"", '25');
$block1->closeRow();


$block1->openRow("");
$block1->cellRow("",'5%',"", '25');
$block1->cellRow($blockPage->buildLink("coodrel.php?tipo_usu=7&",$strings["ger_analrel"]."<br>",in),'60%',"", '25');
$block1->cellRow("<strong>".$contANuser."</strong>",'40%',"", '25');
$block1->closeRow();


$block1->closeContent();
$somaUser = $contANuser + $contGPuser + $contUuser + $contGEuser + $contFuser + $contAuser +$contGuser ;

//
$block1->openPaletteScript();
if ($profilSession == 6 || $profilSession == 0 || $profilSession == 9 || $profilSession == 7) {
	$block1->paletteScript(0, "add","../administration/addusuario.php?", "true,false,false",$strings["add"]);
	}
$block1->closePaletteScript($somaUser,"1");
//

echo "<span id=\"qtd\" style=\"height:20; border:0; position:absolute; right:140; border:0;\" >Total de Usuários: ".$somaUser."</span>";
