...
if ($action == "add") {
	...
	$tmpquery1 = "INSERT INTO ".MYDATABASE.".s_funcao_sgd (no_funcao) VALUES('$tit')";
  ...
  echo "<form  method='POST' onSubmit=\"return verifica_campo();\" action='addrecursodesc.php?".session_name()."=".session_id()."&action=add&project=$project#filedetailsAnchor' name='addsupport' enctype='multipart/form-data' >";
	
       $block1 = new block();
	$block1->heading($strings["n_recurso"]);
	
  echo "<table cellspacing=\"0\" width=\"90%\" border=\"0\" cellpadding=\"3\"  class=\"content\">";
       
       $block1->contentSub(	"Registrar","2") ;

  echo "<tr align='left' class=\"odd\">
            <th colspan=\"2\"></th>
       </tr>";

  echo "<tr class=\"odd\">
           <td>".$strings["titulo"]."</td>
           <td><input size=\"32\" value=\"$tit\" style=\"width: 400px\" name=\"tit\" maxlength=\"32\" type=\"TEXT\"></td>
        </tr>
        <tr class=\"odd\">
           <td></td>
           <td></td>
        ...
        <tr class=\"odd\">
            <td>&nbsp;</td>
            <td><input type=\"SUBMIT\" value=\"".$strings["submit_registrar"]."\"></td>
        </tr>
        </table>
        </form>";
