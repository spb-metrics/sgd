...
if($id_analista == '0' || $id_analista == 0 || $id_analista !=""){
	
$tmp_analista = " AND SG.NO_GRUPO='sgd_analista_relat' ";
     
 }else{

 $tmp_analista = " AND SG.NO_GRUPO='sgd_analista_relat' AND SU.ID=' ".$id_analista." '";
...
if($contAnalista) {                
   ...
   for($i=0; $i < $contAnalista; $i++) {  
    
	 $codigo = $sel_Analista->so_id[$i];
	 $descricao = $sel_Analista->so_login[$i];
