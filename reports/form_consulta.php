...
$blockConsulta = new block();
$blockPageConsulta = new block();
...
$selectUnidades = $blockPageConsulta->insSelect($Unidades->org_id, $Unidades->org_name, "", "unc", "unc", "", $OptUnidades, "", "17", "");
...
$selectSistemas = $blockPageConsulta->insSelect($Sistemas->sis_id, $Sistemas->sis_unidade, "", "si", "si", "", $OptSistemas, "", "17", "");
...
$selectGestores = $blockPageConsulta->insSelect($Gestores->so_id, $Gestores->so_nome, "", "gs", "gs", "", $OptGestores, "", "17", "");
...
$selectPrioridades = $blockPageConsulta->insSelect($Prioridades["value"], $Prioridades["label"], "0", "id_prioridade", "id_prioridade", "", $OptPrioridades, "", "17", "");
//FIM SELECT DE PRIORIDADE

//SELECT DE TIPO DE DEMANDAS
$TipoDemandas = array (
	"value" => array (
		0,
		1,
...
$rowTipoDemandas = count($Prioridades->so_id);
$OptTipoDemandas = array (
	0 => "3",
	1 => "<strong>Selecione Tipo de Demanda</strong>"
);
$selectTipoDemandas = $blockPageConsulta->insSelect($TipoDemandas["value"], $TipoDemandas["label"], "3", "tipo_demanda", "tipo_demanda", "", $OptTipoDemandas, "", "17", "");
//FIM SELECT DE TIPO DE DEMANDAS
...
$OptSituacoes = array (
	0 => "0",
	1 => "<strong>Selecione Situação do Cronograma</strong>"
);
$selectSituacoes = $blockPageConsulta->insSelect($Situacoes["value"], $Situacoes["label"], "", "id_status", "id_status", "", $OptSituacoes, "", "17", "");
...
$selectAnos = $blockPageConsulta->insSelect($Anos, $Anos, "", "an", "an", "", $OptAnos, "", "17", "");
//FIM SELECT DE ANO DEMANDA

//INICIO FORMULARIO
$blockConsulta->openForm("listprojects.php", "form_consulta", "onSubmit='return validar(this)'");
$blockConsulta->openContent();

$blockConsulta->contentTitle("Selecione os critérios do relatório aqui.", "4");

$blockConsulta->openRow("on");
$blockConsulta->cellRow("<input type=\"hidden\" name=\"postDetalhado\" value=\"S\">", "", "", "", "4");
$blockConsulta->closeRow();

$blockConsulta->openRow("on");
$blockConsulta->cellRow("Unidade :&nbsp;", "", "", "", "", "3");
$blockConsulta->cellRow("$selectUnidades", "", "", "", "");
$blockConsulta->cellRow("Sistema :&nbsp;", "", "", "", "", "3");
$blockConsulta->cellRow("$selectSistemas", "", "", "", "");
$blockConsulta->closeRow();

$blockConsulta->openRow("on");
$blockConsulta->cellRow("Prioridade :&nbsp;", "", "", "", "", "3");
$blockConsulta->cellRow("$selectPrioridades", "", "", "", "");
$blockConsulta->cellRow("Tipo da demanda :&nbsp;", "", "", "", "", "3");
$blockConsulta->cellRow("$selectTipoDemandas", "", "", "", "");
$blockConsulta->closeRow();

$blockConsulta->openRow("on");
$blockConsulta->cellRow("Gestor :&nbsp;", "", "", "", "", "3");
$blockConsulta->cellRow("$selectGestores", "", "", "", "");
$blockConsulta->cellRow("Cronograma :&nbsp;", "", "", "", "", "3");
$blockConsulta->cellRow("$selectSituacoes", "", "", "", "");
$blockConsulta->closeRow();

$blockConsulta->openRow("on");
$blockConsulta->cellRow("&nbsp;", "", "", "", "4");
$blockConsulta->closeRow();

$blockConsulta->openRow("on");
$blockConsulta->cellRow("<strong>Ano da Solicitação da Demanda:</strong>", "", "", "", "4", "2");
$blockConsulta->closeRow();

$blockConsulta->openRow("on");
$blockConsulta->cellRow("$selectAnos", "", "", "", "4", "2");
$blockConsulta->closeRow();

$blockConsulta->openRow("on");
$blockConsulta->cellRow("<input type='submit' name='Save' value='Filtrar'>", "", "", "", "4", "2");
$blockConsulta->closeRow();
...
$blockConsulta->closeContent();
$blockConsulta->closeForm();
?>