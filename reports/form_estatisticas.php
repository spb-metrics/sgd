...
$blockEstatisticas = new block();
$blockPageEstatisticas = new block();
...
//SELECT DE UNIDADES
	...
	$selectUnidades = $blockPageEstatisticas->insSelect($Unidades->org_id,$Unidades->org_name,"","ung","ung","",$OptUnidades,"","17","");
...
//SELECT DE SISTEMAS
	...
	$OptSistemas = array(0=>"0",1=>"<strong>Selecione Sistema</strong>");
	$selectSistemas = $blockPageEstatisticas->insSelect($Sistemas->sis_id,$Sistemas->sis_unidade,"","sig","sig","",$OptSistemas,"","17","disabled");
...
//SELECT DE GERENTES DE PROJETO
	...
	$OptGerentes = array(0=>"0",1=>"<strong>Selecione Gerente de Projeto</strong>");
	$selectGerentes = $blockPageEstatisticas->insSelect($Gerentes->so_id,$Gerentes->so_nome,"","grg","grg","",$OptGerentes,"","17","disabled");
...
//SELECT DE GESTORES
	...
	$selectGestores = $blockPageEstatisticas->insSelect($Gestores->so_id,$Gestores->so_nome,"","gsg","gsg","",$OptGestores,"","17","disabled");
...
//SELECT DE ANALISTA DE RELACIONAMENTO
	...
	$OptAnalistas = array(0=>"0",1=>"<strong>Selecione Analista de Relacionamento</strong>");
	$selectAnalistas = $blockPageEstatisticas->insSelect($Analistas->so_id,$Analistas->so_nome,"","anr","anr","",$OptAnalistas,"","17","disabled");
...
//SELECT DE ANO DEMANDA
	...
	$selectAnos = $blockPageEstatisticas->insSelect($Anos,$Anos,"","an","an","",$OptAnos,"","17","");
//FIM SELECT DE ANO DEMANDA

//INICIO FORMULARIO
$blockEstatisticas->openForm("reportsFrameGrafico.php", "form_estatisticas","onSubmit='return validar(this)'");
$blockEstatisticas->openContent();

$blockEstatisticas->contentTitle("Selecione os critérios do relatório aqui.","3");

$blockEstatisticas->openRow("on");
$blockEstatisticas->cellRow("<input type=\"hidden\" name=\"postGerencial\" value=\"S\">","","","","3");
$blockEstatisticas->closeRow();

$blockEstatisticas->openRow("on");
$blockEstatisticas->cellRow("<input name=\"tp\" id=\"tp\" type=\"radio\" value=\"pizza\">","35","","","","3");
$blockEstatisticas->cellRow("Gráfico de Pizza","","","","","1");
$blockEstatisticas->cellRow("<input name=\"tp\" checked type=\"radio\" value=\"barra\"> Gráfico de Barras","150","","","");
$blockEstatisticas->closeRow();

$blockEstatisticas->openRow("on");
$blockEstatisticas->cellRow("<input name=\"op\" id=\"op\" type=\"radio\" onChange=\"enableField(this.value)\" onClick=\"enableField(this.value)\" value=\"1\" checked>","35","","","","3");
$blockEstatisticas->cellRow("Demandas por Unidade","","","","");
$blockEstatisticas->cellRow("$selectUnidades","","","","");
$blockEstatisticas->closeRow();

$blockEstatisticas->openRow("on");
$blockEstatisticas->cellRow("<input name=\"op\" id=\"op\" type=\"radio\" onChange=\"enableField(this.value)\" onClick=\"enableField(this.value)\" value=\"2\">","35","","","","3");
$blockEstatisticas->cellRow("Demandas por Sistema","","","","");
$blockEstatisticas->cellRow("$selectSistemas","","","","");
$blockEstatisticas->closeRow();

$blockEstatisticas->openRow("on");
$blockEstatisticas->cellRow("<input name=\"op\" id=\"op\" type=\"radio\" onChange=\"enableField(this.value)\" onClick=\"enableField(this.value)\" value=\"3\">","35","","","","3");
$blockEstatisticas->cellRow("Demandas por Gestor","","","","");
$blockEstatisticas->cellRow("$selectGestores","","","","");
$blockEstatisticas->closeRow();

$blockEstatisticas->openRow("on");
$blockEstatisticas->cellRow("<input name=\"op\" id=\"op\" type=\"radio\" onChange=\"enableField(this.value)\" onClick=\"enableField(this.value)\" value=\"4\">","35","","","","3");
$blockEstatisticas->cellRow("Demandas por Gerente de Projeto","","","","");
$blockEstatisticas->cellRow("$selectGerentes","355","","","");
$blockEstatisticas->closeRow();

$blockEstatisticas->openRow("on");
$blockEstatisticas->cellRow("<input name=\"op\" id=\"op\" type=\"radio\" onChange=\"enableField(this.value)\" onClick=\"enableField(this.value)\" value=\"5\">","35","","","","3");
$blockEstatisticas->cellRow("Demandas por Analista","","","","");
$blockEstatisticas->cellRow("$selectAnalistas","","","","");
$blockEstatisticas->closeRow();

$blockEstatisticas->openRow("on");
$blockEstatisticas->cellRow("","","","","");
$blockEstatisticas->cellRow("Ano da Solicitação da Demanda :","","","","");
$blockEstatisticas->cellRow("$selectAnos","","","","");
$blockEstatisticas->closeRow();

$blockEstatisticas->openRow("on");
$blockEstatisticas->cellRow("<input type='submit' name=\"Filtrar\" value='Filtrar'>","","","","3","2");
$blockEstatisticas->closeRow();

$blockEstatisticas->openRow("on");
$blockEstatisticas->cellRow("&nbsp;","","","","3");
$blockEstatisticas->closeRow();

$blockEstatisticas->closeContent();
$blockEstatisticas->closeForm();
?>