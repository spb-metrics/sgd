...
$blockControles1 = new block();
$blockControles2 = new block();
$blockControles3 = new block();
$blockControles4 = new block();
$blockControles5 = new block();

$blockPageControles = new block();

//SELECT DE UNIDADES
$tmpquery = "ORDER BY name";
$Unidades = new request();
$Unidades->openOrganizations($tmpquery);
$rowUnidades = count($Unidades->org_id);
$OptUnidades = array (
	0 => "0",
	1 => "<strong>Selecione Unidade</strong>"
);
$selectUnidades = $blockPageControles->insSelect($Unidades->org_id, $Unidades->org_name, "", "ungc", "ungc", "", $OptUnidades, "", "17", "disabled");
//FIM SELECT DE UNIDADES

//SELECT DE SISTEMAS
$tmpquery = " ";
$Sistemas = new request();
$Sistemas->openSisunio($tmpquery);
$rowSistemas = count($Sistemas->sis_id);
$OptSistemas = array (
	0 => "0",
	1 => "<strong>Selecione Sistema</strong>"
);
$selectSistemas = $blockPageControles->insSelect($Sistemas->sis_id, $Sistemas->sis_unidade, "", "sigc", "sigc", "", $OptSistemas, "", "17", "disabled");
//FIM SELECT DE SISTEMAS

//SELECT DE GERENTES DE PROJETO
$tmpquery = "AND SG.NO_GRUPO IN('sgd_gerente_projeto')";
$Gerentes = new request();
$Gerentes->openSousuario($tmpquery);
$rowGerentes = count($Gerentes->so_id);
$OptGerentes = array (
	0 => "0",
	1 => "<strong>Selecione Gerente de Projeto</strong>"
);
$selectGerentes = $blockPageControles->insSelect($Gerentes->so_id, $Gerentes->so_nome, "", "grgc", "grgc", "", $OptGerentes, "", "17", "disabled");
//FIM SELECT DE GERENTES DE PROJETO

//SELECT DE GESTORES
$tmpquery = "AND SG.NO_GRUPO IN('sgd_gestor')";
$Gestores = new request();
$Gestores->openSousuario($tmpquery);
$rowGestores = count($Gestores->so_id);
$OptGestores = array (
	0 => "0",
	1 => "<strong>Selecione Gestor</strong>"
);
$selectGestores = $blockPageControles->insSelect($Gestores->so_id, $Gestores->so_nome, "", "gsgc", "gsgc", "", $OptGestores, "", "17", "disabled");
//FIM SELECT DE GESTORES

//SELECT DE ANALISTA DE RELACIONAMENTO
$tmpquery = "AND SG.NO_GRUPO IN('sgd_analista_relat')";
$Analistas = new request();
$Analistas->openSousuario($tmpquery);
$rowAnalistas = count($Analistas->so_id);
$OptAnalistas = array (
	0 => "0",
	1 => "<strong>Selecione Analista de Relacionamento</strong>"
);
$selectAnalistas = $blockPageControles->insSelect($Analistas->so_id, $Analistas->so_nome, "", "anrc", "anrc", "", $OptAnalistas, "", "17", "disabled");
//FIM SELECT DE ANALISTA DE RELACIONAMENTO
...
$OptMeses = array (
	0 => "0",
	1 => "<strong>Todos os Períodos</strong>"
);
$selectMeses = $blockPageControles->insSelect($Meses["value"], $Meses["label"], "0", "ms", "ms", "", $OptMeses, "", "17", "disabled");
//FIM SELECT DE MESES
...
$selectPeriodosGer = $blockPageControles->insSelect($Periodos["value"], $Periodos["label"], "", "tmger", "tmger", "", $OptPeriodos, "", "17", "");
$selectPeriodosAnr = $blockPageControles->insSelect($Periodos["value"], $Periodos["label"], "", "tmanr", "tmanr", "", $OptPeriodos, "", "17", "disabled");
//FIM SELECT DE PERIODOS

//SELECT DE ANO DEMANDA
$tmpquery = "";
$Anos = yearProjects();
$Anos = array_clear($Anos);
$OptAnos = array (
	0 => "0",
	1 => "<strong>Selecione Ano da Demanda</strong>"
);
$selectAnos = $blockPageControles->insSelect($Anos, $Anos, "", "an", "an", "", $OptAnos, "", "17", "");
$selectAnosCompGer = $blockPageControles->insSelect($Anos, $Anos, "", "anger", "anger", "", $OptAnos, "", "17", "");
$selectAnosCompAnr = $blockPageControles->insSelect($Anos, $Anos, "", "ananr", "ananr", "", $OptAnos, "", "17", "");

//FIM SELECT DE ANO DEMANDA

//INICIO PRIMEIRO FORMULARIO
$blockControles1->openForm("listprojectsTop10PDF.php");
$blockControles1->openContent();

$blockControles1->contentTitle("Demandas Críticas.");

$blockControles1->openRow("on");
$blockControles1->cellRow("&nbsp;", "", "", "", "");
$blockControles1->closeRow();

$blockControles1->openRow("on");
$blockControles1->cellRow("<input type='submit' name='Filtrar' value='Gerar Relatório'>", "", "", "", "", "2");
$blockControles1->closeRow();
...
$blockControles1->closeContent();
$blockControles1->closeForm();
//FIM PRIMEIRO FORMULARIO

//INICIO SEGUNDO FORMULARIO
$blockControles2->openForm("reportsFrameGrafico.php","form_status","onSubmit='return validar(this)'");
$blockControles2->openContent();

$blockControles2->contentTitle("Status Atual.", "4");

$blockControles2->openRow("on");
$blockControles2->cellRow("&nbsp;", "", "", "", "4");
$blockControles2->closeRow();

$blockControles2->openRow("on");
$blockControles2->cellRow("<input OnClick=\"enField(this.value,this.form)\" id=\"opc\" name=\"opc\" type=\"radio\" value=\"0\" checked>", "", "", "", "", "3");
$blockControles2->cellRow("Geral", "", "", "", "");
$blockControles2->cellRow("&nbsp;", "", "", "", "");
$blockControles2->cellRow("&nbsp;", "", "", "", "");
$blockControles2->closeRow();

$blockControles2->openRow("on");
$blockControles2->cellRow("<input OnClick=\"enField(this.value,this.form)\" id=\"opc\" name=\"opc\" type=\"radio\" value=\"4\">", "", "", "", "", "3");
$blockControles2->cellRow("$selectGerentes", "", "", "", "");
$blockControles2->cellRow("<input OnClick=\"enField(this.value,this.form)\" id=\"opc\" name=\"opc\" type=\"radio\" value=\"2\">", "", "", "", "", "3");
$blockControles2->cellRow("$selectSistemas", "", "", "", "");
$blockControles2->closeRow();

$blockControles2->openRow("on");
$blockControles2->cellRow("<input OnClick=\"enField(this.value,this.form)\" id=\"opc\" name=\"opc\" type=\"radio\" value=\"5\">", "", "", "", "", "3");
$blockControles2->cellRow("$selectAnalistas", "", "", "", "");
$blockControles2->cellRow("&nbsp;", "", "", "", "");
$blockControles2->cellRow("&nbsp;", "", "", "", "");
$blockControles2->closeRow();

$blockControles2->openRow("on");
$blockControles2->cellRow("<input OnClick=\"enField(this.value,this.form)\" id=\"opc\" name=\"opc\" type=\"radio\" value=\"3\">", "", "", "", "", "3");
$blockControles2->cellRow("$selectGestores", "", "", "", "");
$blockControles2->cellRow("&nbsp;", "", "", "", "");
$blockControles2->cellRow("&nbsp;", "", "", "", "");
$blockControles2->closeRow();

$blockControles2->openRow("on");
$blockControles2->cellRow("Ano da Solicitaçã da Demanda :", "", "", "", "4", "2");
$blockControles2->closeRow();

$blockControles2->openRow("on");
$blockControles2->cellRow("$selectAnos", "", "", "", "4", "2");
$blockControles2->closeRow();
...
$blockControles2->openRow("on");
$blockControles2->cellRow("<input type='submit' name='Filtrar' value='Gerar Gráfico'>", "", "", "", "4", "2");
$blockControles2->closeRow();

$blockControles2->closeContent();
$blockControles2->closeForm();
//FIM SEGUNDO FORMULARIO

//INICIO TERCEIRO FORMULARIO
$blockControles3->openForm("reportsFrameGrafico.php","form_satisfacao","onSubmit='return validar(this)'");
$blockControles3->openContent("720");

$blockControles3->contentTitle("Pesquisa de Satisfação.", "4");

$blockControles3->openRow("on");
$blockControles3->cellRow("&nbsp;", "", "", "", "4");
$blockControles3->closeRow();

$blockControles3->openRow("on");
$blockControles3->cellRow("<input OnClick=\"enField(this.value,this.form)\" id=\"opc\" name=\"opc\" type=\"radio\" value=\"7\" checked>", "35", "", "", "", "3","1");
$blockControles3->cellRow("Geral", "", "", "", "");
$blockControles3->cellRow("&nbsp;", "", "", "", "");
$blockControles3->cellRow("&nbsp;", "", "", "", "");
$blockControles3->closeRow();

$blockControles3->openRow("on");
$blockControles3->cellRow("<input OnClick=\"enField(this.value,this.form)\" id=\"opc\" name=\"opc\" type=\"radio\" value=\"8\">", "35", "", "", "", "3");
$blockControles3->cellRow("$selectGestores", "235", "", "", "");
$blockControles3->cellRow("&nbsp;", "20", "", "", "");
$blockControles3->cellRow("&nbsp;", "", "", "", "");
$blockControles3->closeRow();

$blockControles3->openRow("on");
$blockControles3->cellRow("<input OnClick=\"enField(this.value,this.form)\" id=\"opc\" name=\"opc\" type=\"radio\" value=\"9\">", "35", "", "", "", "3");
$blockControles3->cellRow("$selectUnidades", "345", "", "", "");
$blockControles3->cellRow("&nbsp;", "20", "", "", "");
$blockControles3->cellRow("&nbsp;", "", "", "", "");
$blockControles3->closeRow();

$blockControles3->openRow("on");
$blockControles3->cellRow("Ano da Solicitaçã da Demanda :", "", "", "", "4", "2");
$blockControles3->closeRow();

$blockControles3->openRow("on");
$blockControles3->cellRow("$selectAnos", "", "", "", "4", "2");
$blockControles3->closeRow();
...
$blockControles3->openRow("on");
$blockControles3->cellRow("<input type='submit' name='Filtrar' value='Gerar Gráfico'>", "", "", "", "4", "2");
$blockControles3->closeRow();

$blockControles3->closeContent();
$blockControles3->closeForm();
//FIM TERCEIRO FORMULARIO

//INICIO QUARTO FORMULARIO
$blockControles4->openForm("reportsFrameGrafico.php","form_comparativo","onSubmit='return validar(this)'");
$blockControles4->openContent("720");

$blockControles4->contentTitle("Comparativos.", "4");

$blockControles4->openRow("on");
$blockControles4->cellRow("<input OnClick=\"enField(this.value,this.form)\" name=\"opc\" id=\"opc\" type=\"radio\" value=\"6\" checked>","35", "", "", "", "3");
$blockControles4->cellRow("Gerentes de Projetos :", "200", "", "", "");
$blockControles4->cellRow("$selectPeriodosGer", "120", "", "", "");
$blockControles4->cellRow("$selectAnosCompGer", "", "", "", "");
$blockControles4->closeRow();

$blockControles4->openRow("on");
$blockControles4->cellRow("<input OnClick=\"enField(this.value,this.form)\" name=\"opc\" id=\"opc\" type=\"radio\" value=\"10\">", "35", "", "", "", "3");
$blockControles4->cellRow("Analista de Relacionamento :","200","", "", "");
$blockControles4->cellRow("$selectPeriodosAnr", "120", "", "", "");
$blockControles4->cellRow("$selectAnosCompAnr", "", "", "", "");
$blockControles4->closeRow();

$blockControles4->openRow("on");
$blockControles4->cellRow("<input OnClick=\"enField(this.value,this.form)\" name=\"opc\" id=\"opc\" type=\"radio\" value=\"15\">", "35", "", "", "", "3");
$blockControles4->cellRow("Abertas X Concluídas :","200","","","");
$blockControles4->cellRow("$selectMeses", "120", "", "", "");
$blockControles4->cellRow("$selectAnos", "", "", "", "");
$blockControles4->closeRow();

$blockControles4->openRow("on");
$blockControles4->cellRow("&nbsp;", "", "", "", "4");
$blockControles4->closeRow();

$blockControles4->openRow("on");
$blockControles4->cellRow("<input type='submit' name='Filtrar' value='Gerar Gráfico'>", "", "", "", "4", "2");
$blockControles4->closeRow();
...
$blockControles4->closeContent();
$blockControles4->closeForm();
//FIM QUARTO FORMULARIO

//INICIO QUINTO FORMULARIO
$blockControles5->openForm("reportsFrameGrafico.php","form_backlog","onSubmit='return validar(this)'");
$blockControles5->openContent();

$blockControles5->contentTitle("Back Log.", "4");

$blockControles5->openRow("on");
$blockControles5->cellRow("", "", "", "", "4");
$blockControles5->closeRow();

$blockControles5->openRow("on");
$blockControles5->cellRow("<input OnClick=\"enField(this.value,this.form)\" name=\"opl\" id=\"opl\" type=\"radio\" value=\"0\" checked>", "35", "", "", "", "3", "3");
$blockControles5->cellRow("Geral", "150", "", "", "");
$blockControles5->cellRow("&nbsp;", "", "", "", "");
$blockControles5->closeRow();

$blockControles5->openRow("on");
$blockControles5->cellRow("<input OnClick=\"enField(this.value,this.form)\" name=\"opl\" id=\"opl\" type=\"radio\" value=\"1\">", "35", "", "", "", "3", "3");
$blockControles5->cellRow("$selectUnidades", "", "", "", "");
$blockControles5->cellRow("<input onClick=\"enField(this.value,this.form)\" name=\"opl\" id=\"opl\" type=\"radio\" value=\"2\">$selectSistemas", "", "", "", "", "1");
$blockControles5->closeRow();

$blockControles5->openRow("on");
$blockControles5->cellRow("<input OnClick=\"enField(this.value,this.form)\" name=\"opl\" id=\"opl\" type=\"radio\" value=\"4\">", "", "", "", "", "3");
$blockControles5->cellRow("$selectGerentes", "", "", "", "");
$blockControles5->cellRow("&nbsp;", "", "", "", "");
$blockControles5->closeRow();

$blockControles5->openRow("on");
$blockControles5->cellRow("<input onClick=\"enField(this.value,this.form)\" name=\"opl\" id=\"opl\" type=\"radio\" value=\"3\">", "35", "", "", "", "3", "3");
$blockControles5->cellRow("$selectGestores", "", "", "", "");
$blockControles5->cellRow("", "", "", "", "");
$blockControles5->closeRow();

$blockControles5->openRow("on");
$blockControles5->cellRow("Ano da Solicitação da Demanda :", "", "", "", "4", "2");
$blockControles5->closeRow();

$blockControles5->openRow("on");
$blockControles5->cellRow("$selectAnos", "", "", "", "4", "2");
$blockControles5->closeRow();
...
$blockControles5->openRow("on");
$blockControles5->cellRow("<input type='submit' name='Filtrar' value='Gerar Gráfico'>", "", "", "", "4", "2");
$blockControles5->closeRow();

$blockControles5->closeContent();
$blockControles5->closeForm();
?>