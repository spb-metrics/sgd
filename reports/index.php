...
$block1->heading($strings["reports"]);

$block1->openContent();

if ($profilSession == 6 || $profilSession == 9 || $profilSession == 10) {
	$block1->openRow();
	echo "<div style=\"margin-bottom: -4px; margin-left: 2px \">".$blockPage->buildLink("Javascript:ChangeImagem(1,'consulta',5)","<img src=\"../themes/".THEME."/consulta_over.gif\" name=\"imagem1\" id=\"imagem1\" width=\"120\" height=\"23\" border=\"0\">", "out")
	.$blockPage->buildLink("Javascript:ChangeImagem(2,'estatistica',5)", "<img src=\"../themes/".THEME."/estatistica.gif\" name=\"imagem2\" id=\"imagem2\" width=\"120\" height=\"23\" border=\"0\">", "out")
	.$blockPage->buildLink("Javascript:ChangeImagem(3,'gerencial',5)", "<img src=\"../themes/".THEME."/gerencial.gif\" name=\"imagem3\" id=\"imagem3\" width=\"120\" height=\"23\" border=\"0\">", "out")
	.$blockPage->buildLink("Javascript:ChangeImagem('4','prioridade',5)", "<img src=\"../themes/".THEME."/prioridade.gif\" name=\"imagem4\" id=\"imagem4\" width=\"120\" height=\"23\" border=\"0\">", "out")
	.$blockPage->buildLink("Javascript:ChangeImagem('5','servicos',5)", "<img src=\"../themes/".THEME."/servicos.gif\" name=\"imagem5\" id=\"imagem5\" width=\"120\" height=\"23\" border=\"0\">", "out");
	//.$blockPage->buildLink("Javascript:ChangeImagem('6','controle',6)", "<img src=\"../themes/".THEME."/controle.gif\" name=\"imagem6\" id=\"imagem6\" width=\"120\" height=\"23\" border=\"0\">", "out");
	echo "</div>";
	$block1->closeRow();
?>
	<tr>
	  <td colspan="6" width="100%">
	    <div id="div1" align="left" style="display: block"><?php include("form_consulta.php");     ?></div>
	    <div id="div2" align="left" style="display: none"> <?php include("form_estatisticas.php"); ?></div>
	    <div id="div3" align="left" style="display: none"> <?php include("form_gerencial.php");    ?></div>
	    <div id="div4" align="left" style="display: none"> <?php include("form_prioridades.php");  ?></div>
	    <div id="div5" align="left" style="display: none"> <?php include("form_servicos.php");     ?></div>
	    <!-- <div id="div6" align="left" style="display: none"> <?php include("form_controle.php");?></div> -->
	  </td>
	</tr>
<?php
} else {
	$block1->openRow();
	echo "<div style=\"margin-bottom: -4px; margin-left: 2px \">".$blockPage->buildLink("Javascript:ChangeImagem('1','consulta',4)", "<img src=\"../themes/".THEME."/consulta_over.gif\" name=\"imagem1\" id=\"imagem1\" width=\"120\" height=\"23\" border=\"0\">", "out")
	.$blockPage->buildLink("Javascript:ChangeImagem('2','estatistica',4)", "<img src=\"../themes/".THEME."/estatistica.gif\" name=\"imagem2\" id=\"imagem2\" width=\"120\" height=\"23\" border=\"0\">", "out")
	.$blockPage->buildLink("Javascript:ChangeImagem('3','prioridade',4)", "<img src=\"../themes/".THEME."/prioridade.gif\" name=\"imagem3\" id=\"imagem3\" width=\"120\" height=\"23\" border=\"0\">", "out")
	.$blockPage->buildLink("Javascript:ChangeImagem('4','servicos',4)", "<img src=\"../themes/".THEME."/servicos.gif\" name=\"imagem4\" id=\"imagem4\" width=\"120\" height=\"23\" border=\"0\">", "out");
	echo "</div>";
	$block1->closeRow();
?>
	<tr>
	  <td colspan="6" width="100%">
	    <div id="div1" align="left" style="display: block"><?php include("form_consulta.php");     ?></div>
	    <div id="div2" align="left" style="display: none"> <?php include("form_estatisticas.php"); ?></div>
	    <div id="div3" align="left" style="display: none"> <?php include("form_prioridades.php");  ?></div>
	    <div id="div4" align="left" style="display: none"> <?php include("form_servicos.php");     ?></div>
	  </td>
	</tr>
<?php 
}
