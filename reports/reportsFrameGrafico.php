...
/*
 * Variaveis para relatorios Gerais
*/
$grafico = $_REQUEST['tp'];
$operacao = $_REQUEST['op'];
$gr = $_REQUEST['gr'];
$unidade = $_REQUEST['ung'];
$sistema = $_REQUEST['sig'];
$gestor = $_REQUEST['gsg'];
$analista = $_REQUEST['anr'];
$ano = $_REQUEST['an'];
$gerente = $_REQUEST['grg'];
$area = $_REQUEST['bs'];

/*
 * Variaveis para relatorio de Controle
*/
$tp_control = $_REQUEST['tp'];
$op_control = $_REQUEST['opc'];
$gr_control = $_REQUEST['grc'];
$un_control = $_REQUEST['ungc'];
$si_control = $_REQUEST['sigc'];
$gs_control = $_REQUEST['gsgc'];
$an_control = $_REQUEST['an'];
$an_congerp = $_REQUEST['anger'];
$an_conanar = $_REQUEST['ananr'];
$grg_control = $_REQUEST['grgc'];
$anr_control = $_REQUEST['anrc'];
$ups_control = $_REQUEST['ungcps'];
$gps_control = $_REQUEST['gsgcps'];
$tm_control = $_REQUEST['tm'];
$tm_congerp = $_REQUEST['tmger'];
$tm_conanar = $_REQUEST['tmanr'];
$anl_control = $_REQUEST['tm_anl'];
$ms_control = $_REQUEST['ms'];

/*
 * Variaveis para relatorio de Back Log
*/
$an_backlog = $_REQUEST['an'];
$opl_backlog = $_REQUEST['opl'];
$gest_backlog = $_REQUEST['gsl'];
$gerproj_backlog = $_REQUEST['grl'];
$uni_backlog = $_REQUEST['unl'];
$sis_backlog = $_REQUEST['sil'];
...
/*
 *  Graficos para Relatorio Gerais
*/
if ($grafico == 'barra') {
	$block1->openContent();
	$block1->openRow("on");
	$block1->cellRow("<div aling=\"center\"><iframe height='440' width='740' frameborder='0' src='graficoBarra.php?op=$operacao&gr=$gr&ung=$unidade&sig=$sistema&grg=$gerente&gsg=$gestor&anr=$analista&an=$ano'></iframe></div>", "", "", "", "");
	$block1->closeRow();
	$block1->closeContent();
}
elseif ($grafico == 'pizza') {
	$block1->openContent();
	$block1->openRow("on");
	$block1->cellRow("<div aling=\"center\"><iframe height='440' width='740' frameborder='0' src='graficoPizza.php?op=$operacao&gr=$gr&ung=$unidade&sig=$sistema&grg=$gerente&gsg=$gestor&anr=$analista&an=$ano'></iframe></div>", "", "", "", "");
	$block1->closeRow();
	$block1->closeContent();
}
elseif ($grafico == 'servicos') {
	$block1->openContent();
	$block1->openRow("on");
	$block1->cellRow("<div aling=\"center\"><iframe height='440' width='740' frameborder='0' src='graficoServicos.php?as=$area&an=$ano'></iframe></div>", "", "", "", "");
	$block1->closeRow();
	$block1->closeContent();
}

/*
 *  Graficos para Relatorio de Controles
*/
elseif ($op_control == '15' || $op_control == '0' || $op_control == '1' || $op_control == '2' || $op_control == '3' || $op_control == '4' || $op_control == '5') {
	$block1->openContent();
	$block1->openRow("on");
	$block1->cellRow("<div aling=\"center\"><iframe height='440' width='760' frameborder='0' src='graficoBarraControle.php?opc=$op_control&grc=$gr_control&ungc=$un_control&sigc=$si_control&grgc=$grg_control&anrc=$anr_control&gsgc=$gs_control&ms=$ms_control&an=$an_control'></iframe></div>", "", "", "", "");
	$block1->closeRow();
	$block1->closeContent();
}
elseif ($op_control == '7' || $op_control == '8' || $op_control == '9') {
	$block1->openContent();
	$block1->openRow("on");
	$block1->cellRow("<div aling=\"center\"><iframe height='440' width='760' frameborder='0' src='graficoSatisfacaoControle.php?opc=$op_control&grc=$gr_control&ungc=$un_control&ungcpsc=$ups_control&gsgcpsc=$gps_control&sigc=$si_control&grgc=$grg_control&anrc=$anr_control&gsgc=$gs_control&an=$an_control'></iframe></div>", "", "", "", "");
	$block1->closeRow();
	$block1->closeContent();
}
elseif ($op_control == '6') {
	$block1->openContent();
	$block1->openRow("on");
	$block1->cellRow("<div aling=\"center\"><iframe height='440' width='760' frameborder='0' src='graficob.php?op=$op_control&tm=$tm_congerp&tm_anl=$anl_control&da_df=$da_df&an=$an_congerp'></iframe></div>", "", "", "", "");
	$block1->closeRow();
	$block1->closeContent();
}
elseif ($op_control == '10') {
	$block1->openContent();
	$block1->openRow("on");
	$block1->cellRow("<div aling=\"center\"><iframe height='440' width='760' frameborder='0' src='graficob.php?op=$op_control&tm=$tm_conanar&tm_anl=$anl_control&da_df=$da_df&an=$an_conanar'></iframe></div>", "", "", "", "");
	$block1->closeRow();
	$block1->closeContent();
}

/*
 *  Graficos para Relatorio de Back Log
*/
elseif ($opl_backlog == '0' || $opl_backlog == '1' || $opl_backlog == '2' || $opl_backlog == '3' || $opl_backlog == '4') {
	$block1->openContent();
	$block1->openRow("on");
	$block1->cellRow("<div aling=\"center\"><iframe height='440' width='760' frameborder='0' src='graficoLinha.php?opl=$opl_backlog&an=$an_backlog&unl=$uni_backlog&sil=$sis_backlog&gsl=$gest_backlog&grl=$gerproj_backlog'></iframe></div>", "", "", "", "");
	$block1->closeRow();
	$block1->closeContent();
} 
else {
	echo "Escolha o tipo de gráfico";
}
