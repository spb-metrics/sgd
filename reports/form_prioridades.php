...
$blockPrioridades = new block();
$blockPagePrioridades = new block();
...
//SELECT DE UNIDADES
	...
	$selectUnidades = $blockPagePrioridades->insSelect($Unidades->org_id,$Unidades->org_name,"","unst","unst","",$OptUnidades,"","17","");
...
//SELECT DE SISTEMAS
	...
	$selectSistemas = "<select name=\"sist\" id=\"sist\" class=\"odd\" style=\"height: 17px\">\n";
	$selectSistemas.= "  <option id=\"optsist\" value=\"0\">Selecione o Sistema</option>\n"; 
...
//SELECT DE GESTORES
	...
	$selectGestores = $blockPagePrioridades->insSelect($Gestores->so_id,$Gestores->so_nome,"","gsst","gsst","",$OptGestores,"","17","onchange=\"Dados('sist','sistemas.php','optsist',this.value,'gestor','Selecione um Sistema','');\"");
...
//SELECT DE GERENTES DE PROJETO
	...
	$selectGerentes = $blockPagePrioridades->insSelect($Gerentes->so_id,$Gerentes->so_nome,"","grpst","grpst","",$OptGerentes,"","17","");
...
//SELECT DE ANO DEMANDA
	...
	$selectAnos = $blockPagePrioridades->insSelect($Anos,$Anos,"","an","an","",$OptAnos,"","17","");
//FIM SELECT DE ANO DEMANDA

//INICIO FORMULARIO
$blockPrioridades->openForm("listprojectsPrioridadesPDF.php");
$blockPrioridades->openContent();

$blockPrioridades->contentTitle("Selecione os critérios do relatório aqui.","4");

$blockPrioridades->openRow("on");
$blockPrioridades->cellRow("<input type=\"hidden\" name=\"opcao\" value=\"1\" checked>","","","","4");
$blockPrioridades->closeRow();

$blockPrioridades->openRow("on");
$blockPrioridades->cellRow("Gestor :&nbsp;","","","","2","3");
$blockPrioridades->cellRow("$selectGestores","490","","","2");
$blockPrioridades->closeRow();

$blockPrioridades->openRow("on");
$blockPrioridades->cellRow("Sistemas :&nbsp;","","","","2","3");
$blockPrioridades->cellRow("$selectSistemas","490","","","2");
$blockPrioridades->closeRow();

$blockPrioridades->openRow("on");
$blockPrioridades->cellRow("Unidade :&nbsp;","","","","2","3");
$blockPrioridades->cellRow("$selectUnidades","490","","","2");
$blockPrioridades->closeRow();

$blockPrioridades->openRow("on");
$blockPrioridades->cellRow("Gerente de Projetos :&nbsp;","","","","2","3");
$blockPrioridades->cellRow("$selectGerentes","490","","","2");
$blockPrioridades->closeRow();

$blockPrioridades->openRow("on");
$blockPrioridades->cellRow("&nbsp;","","","","4");
$blockPrioridades->closeRow();

$blockPrioridades->openRow("on");
$blockPrioridades->cellRow("<input type='submit' name='Save' value='Filtrar'>","","","","4","2");
$blockPrioridades->closeRow();
...
$blockPrioridades->closeContent();
$blockPrioridades->closeForm();
?>