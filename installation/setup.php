...
STAMP;
    ...
    if (!$error) 
	{
		...
		$msg .= "<br/>Tabelas e arquivos de configurações criados com sucesso.";
...
$blockPage->itemBreadcrumbs("<a href='../installation/setup.php'>Instalação</a>");
...
elseif ($step > "1") 
{
    $blockPage->itemBreadcrumbs("<a href='../installation/setup.php?step=1'>Licença</a>");
	...
	elseif ($step > "2") 
	{
		$blockPage->itemBreadcrumbs("<a href='../installation/setup.php?step=2'>Configurações</a>");
		if ($step == "3") 
		{
...
if ($step == "2") 
{
	...
	echo "	<tr class='odd'>
				<td valign='top' class='leftvalue'>Instalação :</td>
