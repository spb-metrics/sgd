...
$status = array(0 => "Validado pelo Cliente", 1 => "Em Análise", 2 => "Suspensa", 3 => "Aberta", 4 => "Validado pelo Relacionamento", 5 => "Validado pela TI", 6 => "Em Andamento", 7 => "Aguardando Homologação", 8 => "Aceito pelo Cliente", 9 => "Em Homologação",  10 => "Concluído" ,  11 => "Cancelada",  12 => "Pendente");
$profil = array(0 => "Administrador", 1 => "Gerente de Projeto", 2 => "Usuário", 3 => "Usuário de Cliente", 4 => "Inativo", 5 => "Diretor de Projeto");
$fase_array = array(1 =>"Planejamento",2 =>"Requisito",3 =>"Desenvolvimento",4 =>"Teste", 5 => "Homologação", 6 =>"Treinamento",  7 =>"Implantação");
$priority = array(0 => "Nenhuma", 1 => "Muito Baixa", 2 => "Baixa", 3 => "Média", 4 => "Maxima", 5 => "Alta");
$status_s =   array(1 => "A Definir", 2 => "Em dia", 3 => "Em atraso", 5 => "Replanejado");
$escala = array(1 => "Divisão", 2 => "Coordenação", 3 => "Coordenação Geral", 4 => "Diretória", 5 => "Presidência" );
$dispensa_array = array(0 =>"Atestado", 1 =>"Férias", 2 =>"Licenças" , 3 =>"Recesso");
$tipo_demanda = array(0 => "Novo Sistema", 1 => "Corretiva", 2 => "Evolutiva", 3 => "Serviços" );
$tipo_servico = array(5 => "Produção", 6 => "Web", 7 => "Gestão de Conhecimento", 8 => "Infraestrutura");
...
$strings["preferences"] = "Dados Pessoais";
$strings["buscar"] = "Buscar";
$strings["demanda"] = "Demanda";
$strings["demandas"] = "Demandas";
$strings["n_demandas"] = "Novas Demandas";
$strings["numero_demanda"] = "Numero da demanda";
$strings["detalhamento"] = "Detalhamento";
$strings["objetivo"] = "Objetivo";
$strings["location"] = "Localização";
$strings["localiza"] = "Localização";
$strings["dereuniao"] = "de Reuniões";
$strings["atareuniao"] = "Atas de Reunião";
$strings["data_divuga"] = "Divugado";
$strings["datareuniao"] = "Data Reunião";
...
$strings["details_hora"] = "Horas Definida no mês";
$strings["none"] = "Não";
...
$strings["my_projects"] = "Minhas Demandas";
$strings["my_demandas"] = "Identificação da Demanda";
$strings["num_demanda"] = "Nº da Demanda";
$strings["def_escopo"] = "Definição de Escopo";
$strings["image_erro"] = "Informações sobre Erro";
$strings["info_erro"] = "Informar Erro";
$strings["info_arquivo"] = "Informe Titulo e Arquivo";
$strings["fase_demanda"] = "Fases da Demanda";
$strings["project"] = "Demanda";
...
$strings["owner"] = "Dono";
$strings["home"] = "Início";
$strings["projects"] = "Demandas";
//$strings["projects"] = "Projetos";
$strings["arquivo"] = "Arquivo";
...
$strings["escala"] = "Escala";
$strings["titulo"] = "Título";
$strings["t_demanda"] = "Título da Demanda";
$strings["tipo_demanda"] = "Tipo";
$strings["statuss"] = "Cronograma";
$strings["sistema"]= "Sistema";
$strings["area_responsavel"] = "Área Responsável";
$strings["uni_adm"] = "Unidade Administrativa";
$strings["nome_gestor"] = "Nome do Gestor";
$strings["resp_relaciona"] = "Gerente Relacionamento";
$strings["dt_inicop"] = "Início Planejado";
$strings["dt_inicre"] = "Início Realizado";
$strings["dt_fimcop"] = "Fim Planejado";
$strings["dt_fimre"] = "Fim Realizado";
$strings["justifica"] = "Obs";
$strings["smudanca"] = " Mudança";
$strings["termoaceite"] = "Satisfação do Cliente";
$strings["so_mudanca"] = "Requisição de Mudança";
$strings["sol_mudanca"] = "Solicita Mudança";
$strings["titulo"] = "Título";
$strings["erro"] = "Salvar erro";
$strings["dt_abertura"] = "Data Abertura";
$strings["dt_atividade"] = "Data de Atividade";
$strings["descricao_atividade"] = "Descrição Atividade";
$strings["descricao"] = "Descrição";
$strings["name"] = "Nome";
$strings["id"] = "ID";
...
$strings["user_perfil"] = "Alterar Perfil";
$strings["user_management"] = "Gerenciamento de Usuários";
$strings["user_management_recurso"] = "Gerenciamento de Usuários no Recurso";
$strings["recurso_management"] = "Gerenciamento de Recursos";
$strings["feriado_management"] = "Gerenciamento de Feriados";
$strings["recurso_newlevel"] = "Novo nivel de recursos";
$strings["recurso"] = "Recurso";
$strings["n_recurso"] = "Nova Funçao";
$strings["gestao_recurso"] = "Gestão de recursos";
$strings["ger_gest"] = "Gestor";
$strings["ger_coordrel"] = "Coordenador de Relacionamento";
//$strings["ger_coordfab"] = "Coordenador de Fábrica";
$strings["ger_coordfab"] = "PMO";
$strings["ger_ger"] = "Gerencial";
$strings["ger_consulta"] = "Consulta";
$strings["ger_gerproj"] = "Gerente de Projeto";
$strings["ger_analrel"] = "Analista de Relacionamento";
$strings["mail_management"] = "Gerenciamento de Email";
$strings["action_management"] = "Gerenciamento de Ação";
$strings["autentica_management"] = "Gerenciamento de Autenticação"; 
...
$strings["project_manager_reponsavel"] = "Resp. da Área";
$strings["user_permissions"] = "Gestor";
$strings["account_created"] = "Conta Criada";
$strings["coordenacao_relacionamento_permissions"] = "Coordenador de Relacionamento";
$strings["coor_r_a"] = "Coor. Relacionamento e Atendimento";
$strings["analista_relacionamento_permissions"] = "Analista de Relacionamento";
$strings["coor_fabrica"] = "Coor. Fabrica";
$strings["usuario_comum_permissions"] = "Usuário";
...
$strings["delete_projects"] = "Excluir Demandas";
...
$strings["hours"] = "horas";
$strings["nova_atividade"] = "Nova Atividade";
$strings["hora_atividade"] = "Horas de Atividade";
$strings["usuario_atividade"] = "Atividades por demanda";
$strings["atividade_recurso"] = "Atividades recurso";
$strings["atividade_mes"] = "Atividades do mês";
$strings["feriado_mes"] = "Feriado do mês";
...
$strings["atividade"] = "Atividade";
$strings["logout_time"] = "Sair Automáticamente";
$strings["noti_foot1"] = "Esta notificação foi gerada pelo SGD.";
...
$strings["login_password2"] = "Senha incorreta.";
$strings["login_clientuser"] = "Este é uma conta de usuário de cliente. Você não pode acessar o SGD com uma conta de usuário de cliente.";
...
$strings["your_projectsite"] = "ao Sistema de Gestão de Demanda - SGD";
...
$strings["export"] = "Importar Documento";
...
$strings["calendar_reuniao"] = "Calendário de Reunião";
$strings["dateso"] = "Data";
...
$strings["submit_registrar"] = "Registrar";
...
$strings["demandas_management"] = "Gerenciamento de Demandas";
...
$strings["bemvindo"] = "Bem-vindo ao Sistema de Gestao de Demanda - SGD";
