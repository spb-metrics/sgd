...
$status = array(0 => "Validado pelo Cliente", 1 => "Em Análise", 2 => "Não Iniciado", 3 => "Aberta", 4 => "Validado pelo Relacionamento", 5 => "Validado pela TI", 6 => "Em Andamento", 7 => "Aguardando Homologação", 8 => "Aceito pelo Cliente", 9 => "Em Homologação",  10 => "Em Produção" ,  11 => "Cancelada",  12 => "Pendente");
...
$status_s =   array(1 => "A Definir", 2 => "Em dia", 3 => "Em atraso", 5 => "Replanejar");
$tipo_demanda = array(0 => "Novo Produto", 1 => "Corretiva", 2 => "Evolutiva");
