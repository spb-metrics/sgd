...
$help["admin_update"] = "Considere sempre a notificação indicando para você atualizar sua versão.<br/><br/>&nbsp;&nbsp;1. Editar Configurações - Opções gerais para FTP, servidor de email, temas, módulos suplementares, etc;<br/><br/>&nbsp;&nbsp;2. Editar Banco de Dados - Atualização dependendo da sua versão anterior do SGD.";
...
//2.5 fullo
$help["newsdesk_links"] = "Para adicionar múltiplos links relacionados use um ponto-e-vírgula entre cada link. Ex: http://php.org/; http://SGD.com/";
?>