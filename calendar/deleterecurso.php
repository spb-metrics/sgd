...
if ($action == "delete") {
	...
	$tmpquery1 = "DELETE FROM SGD_FNDE.S_RECURSO_PROJETO WHERE NU_SEQ_REC_PROJ IN($id)";
	connectSql("$tmpquery1");

	//INI RECURSO PROJETO ATUALIZA A ULTIMA DATA
	$tmpquery = "  WHERE   RPRO.NU_SEQ_PROJETO='".$_SESSION['id_pro']."'  ORDER BY RPRO.DT_RECURSO_PROJETO DESC  ";
	
	$listCalendarScan1 = new request();
	$listCalendarScan1->openRecprojeto($tmpquery);
	$comptListCalendarScan = count($listCalendarScan1->recpro_id);
	//echo $comptListCalendarScan;
	
	$tmpqueryy = "UPDATE sgd_fnde.fases SET data_fim_real='".$listCalendarScan1->recpro_data[0]."' WHERE id_projeto = '".$_SESSION['id_pro']."' AND tipo_fase='7' ";
	connectSql("$tmpqueryy");
//exit;
	//FIM RECURSO PROJETO ATUALIZA A ULTIMA DATA

	headerFunction("../calendar/recursocalendar.php?id=".$_SESSION['id_pro']."&".session_name()."=".session_id());
	exit;
}
...
$block1 = new block();
$block1->form = "saP";
$block1->openForm("../calendar/deleterecurso.php?project=$project&action=delete&id=$id&".session_name()."=".session_id());
...
*/
//INI RECURSO PROJETO
$tmpquery = " WHERE RPRO.NU_SEQ_REC_PROJ = '".$id."'  ";
...
//echo $comptListCalendarScan;
//FIM RECURSO PROJETO
for ($i=0;$i<$comptListCalendarScan;$i++) {

	//INI MOSTRA ATIVIDADE
	$tmpqry = "WHERE RA.NU_SEQ_ATIVIDADE = '".$listCalendarScan1->recpro_atividade[$i]."' ";
	$selAtv = new request();
	$selAtv->openRecursoativ($tmpqry);
	$contselAtv = count($selAtv->rec_id);
	//$selAtv->rec_descricao[0];
	
	//echo $contselAtv;
	//FIM MOSTRA ATIVIDADE
	
echo "<tr class=\"odd\"><td valign=\"top\" colspan=\"2\"  align=\"left\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#".$listCalendarScan1->recpro_id[$i]." Atividade:  ".$selAtv->rec_descricao[0]."</td></tr>";
echo "<tr class=\"odd\"><td valign=\"top\" class=\"leftvalue\"></td><td>&nbsp;Data: ".invert_data($listCalendarScan1->recpro_data[$i])."h</td></tr>";
echo "<tr class=\"odd\"><td valign=\"top\" class=\"leftvalue\"></td><td>&nbsp;Hora de Atividade: ".$listCalendarScan1->recpro_hora[$i]."h</td></tr>";
}
