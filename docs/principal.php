...
<?
//<p align="center"><strong><font color="#FF0000" size="5" face="Verdana, Arial, Helvetica, sans-serif">Aten&ccedil;&atilde;o: 
//  este sistema<br>
//  est&aacute; em constru&ccedil;&atilde;o!</font></strong></p>
//<table width="75%" border="0" align="center">
//
//  <tr>
//    <td><p><font size="2" face="Verdana, Arial, Helvetica, sans-serif">O CACIC 
//        &eacute; um software que auxilia os administradores de sistemas a gerenciar 
//        os computadores que s&atilde;o de sua responsabilidade.</font> </p>
//      <p><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Para usar 
//        o sistema basta escolher a op&ccedil;&atilde;o desejada no menu da esquerda.</font></p></td>
//  </tr>
//</table>
?>
...
//	include_once 'graficos/pie_so.php';	
	if ($_SESSION["nm_grupo_usuarios"] == 'adm1')
		{
		echo '</a>';
		}		
  ...
  <tr> 
    <td class="descricao"><div align="center"> Distribui&ccedil;&atilde;o por 
        sistemas operacionais dos computadores gerenciados</div></td>
  </tr>
  ...
  <tr> 
    <td>
	<? 
	echo '<img src="graficos/pie_mac.php" border="no">';
	?>	
	</td>
  </tr>
  <tr> 
    <td class="descricao"><div align="center">Total de computadores baseado no 
        Mac-Address</div></td>
  </tr>
...
<p align="center">Desenvolvido pelo Escrit&oacute;rio Estadual da Dataprev do Esp&iacute;rito Santo
