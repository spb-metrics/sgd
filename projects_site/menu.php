...
//if (($profilSession == 8) || ($profilSession == 1) || ($profilSession == 9) || ($profilSession == 3 )){
$blockH = new block();
echo '<table width="98%" border="0" cellpadding="0" cellspacing="0" >';
echo '<tr align="left">
    <td width="2%" >&nbsp;</td>';
if ($profilSession == 3) {
	echo "<td width=\"100\"><a href='../projects_site/addprojects.php?$transmitSid&changeProject=true' onMouseOver=\"return window.status='Novas Demandas'\" onMouseOut=\"return window.status=''\">" . $strings["n_demandas"] . "</a></td>";
	echo '<td width="2%">|</td>';
}
echo "<td width=\"105\"><a href='../projects_site/home.php?&fillter=true&fill=&$transmitSid&changeProject=true' onMouseOver=\"return window.status='Minhas Demandas'\" onMouseOut=\"return window.status=''\" >" . $strings["my_projects"] . "</a> </td>";
echo '<td width="2%">|</td>';
echo "<td width=\"45\"><a href=\"../reports/index.php?$transmitSid\" onMouseOver=\"return window.status='Relatorios'\" onMouseOut=\"return window.status=''\">".$strings["reports"]."</a></td>";
echo '<td width="2%">|</td>';

echo "<td width=\"10%\">" . $blockH->buildLink("../projects_site/home.php?situa=10&changeProject=true", $strings["historico"], in) . "</td>";

echo "<td width=\"100\"></td>";
echo "<td width=\"25%\"  align=\"right\">$titlePage | <a href='../general/login.php?logout=true' onMouseOver=\"return window.status='Sair'\" onMouseOut=\"return window.status=''\">" . $strings["logout"] . "</a></td>";
echo '</tr></table>';
