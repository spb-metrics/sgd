...
$tmpa = "INSERT INTO ".$tableCollab["termo_aceite"]."(relacionamento, comunica, alinha, solucao,prazo, performace ,estabilidade ,erros ,atendimento ,pontualidade,ambiente ,cenario ,id_projeto, id_menber) VALUES('6','6','6','6','6','6','6','6','6','6','6','6','$projectSession','$idSession')";
connectSql("$tmpa");
...
$tmpmail = " AND ( SU.nu_seq_usuario='".$projectDetail->pro_men_analista[0]."' OR SU.nu_seq_usuario='".$projectDetail->pro_mem_idgpro[0]."' OR  mem.profil IN(10,6) ) " ;
	...
	$contmail = count($usermail->mem_id);
		...
		//$enviar = "true";
		$envimail = new email();
		$envimail->enviar('Aceito Pelo Cliente','Demanda numero '.$projectSession.' - '.$nameprojeto.' <br>Aceite Final realizado pelo Cliente,<br>Mas sem preenchimento do termo de satisfação! ', $usermail->mem_email_work[$um]);
		...
		$gera->referencia($dateh,'1',$projectSession,'Aceito Pelo Cliente Sem Satisfaçao',$oi);

/* echo '<script>alert("Aceite realizado com sucesso!");</script>'; */
...
<body>
  ...
  <table width="100%" height="50" border="0" cellpadding="0" cellspacing="0" bordercolor="#A3B2CC" bgcolor="#CCCCCC">
    <tr>
      <td colspan="4">&nbsp;</td>
    </tr>
    <tr>
      <td width="2%" rowspan="2">&nbsp;</td>
      <td colspan="2" align="center"><strong>DEMANDA ACEITA!</strong></td>
      <td width="2%" rowspan="2">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
      <td>&nbsp;</td>
      <td colspan="2" align="center"><form class="func" name="form1" method="post" action="">
        <table width="98%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="center"><input name="naceito" type="submit" value="CONFIRMAR"></td>
      </tr>
        </table>
      </form></td>
    </tr>
