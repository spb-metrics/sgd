...
echo "<tr>
			...
			<td><input type='text' name='sd' id='sel1' size='20' value='$sd' />
	...
	<tr>
		...
		<td>
			<input type='text' name='dd' id='sel3' size='20' value='$dd' />
			<input type='reset' value=' ... ' onclick=\"return showCalendar('sel3', '%Y-%m-%d');\" />
		</td>
	</tr>
	<tr>
