...
if ($action == "add") {
	...
	$tmpquery1 = "INSERT INTO ".$tableCollab["solicita_mudanca"]."(titulo,descricao,data,id_projeto,id_usuario) VALUES('$tit','$mes','".date('Y-m-d')."','$projectSession','$idSession')";
...
echo "<form method='POST' onSubmit=\"return verifica_campo();\" action='../projects_site/addmudanca.php?".session_name()."=".session_id()."&action=add&project=$projectSession#filedetailsAnchor' name='addsupport' enctype='multipart/form-data' >";
	$block1 = new block();
	...
	echo "	<table cellpadding='0' cellspacing='0' border='0'>
			...
			<tr class='$class' onmouseover=\"this.style.backgroundColor='".$blockz1->highlightOn."'\" onmouseout=\"this.style.backgroundColor='".$highlightOff."'\">
				...
				<td align='right'>&nbsp;</td><td >&nbsp;JANE       Telefone: 4023</td>
			</tr>";
			echo "<tr>
				<th nowrap class='FormLabel' align='left'>&nbsp;&nbsp;&nbsp; ".$strings["resp_relaciona"]." :</th>
				<td align='right'>&nbsp;</td><td >&nbsp;ROGERIO     Telefone: 4584</td>
			</tr>";
			//".$nome_g_rel."
			echo "<tr>
