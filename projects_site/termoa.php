...
$tmpa = "INSERT INTO ".$tableCollab["termo_aceite"]."(relacionamento, comunica, alinha, solucao,prazo, performace ,estabilidade ,erros ,atendimento ,pontualidade,ambiente ,cenario ,id_projeto, id_menber) VALUES('$sati','$comu','$alin','$reso','$praz','$perf','$esta','$erro','$atend','$pont','$hamb','$pront','$projectSession','$idSession')";
connectSql("$tmpa");
...
//$projectDetail->pro_mem_idgpro[0] ;
//$projectDetail->pro_men_analista[0];
$tmpmail = " AND ( SU.nu_seq_usuario='".$projectDetail->pro_men_analista[0]."' OR SU.nu_seq_usuario='".$projectDetail->pro_mem_idgpro[0]."' OR  mem.profil IN(10,6) ) " ;
...
//GERA LOG
	...
	$contmail = count($usermail->mem_id);
		...
		//$enviar = "true";
		$envimail = new email();
		$envimail->enviar('Aceito Pelo Cliente','Demanda numero '.$projectSession.' - '.$nameprojeto.' <br>Aceite Final realizado pelo Cliente<br>', $usermail->mem_email_work[$um]);
		...
		//exit;
           ...
           $gera->referencia($dateh,'1',$projectSession,'Aceito Pelo Cliente',$oi);


echo '<script>alert("Aceite registrado com sucesso!");</script>';
echo "<script>window.opener.document.location.href='home.php?id=".$projectSession."';</script><br>"; 
...
<script language='JavaScript' src='../themes/default/scripts.js'></script><style type="text/css">
<?php
...
<table width="100%" height="580" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="4" valign="middle" bgcolor="#CCCCCC"><form name="form1" method="post" action="">
      <table width="95%" height="95%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        ...
        <tr>
          <td width="2%">&nbsp;</td>
          <td colspan="2" align="center" bgcolor="#CCCCCC"><strong>TERMO DE SATISFA&Ccedil;&Atilde;O </strong></td>
          <td width="2%">&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        ...
        <tr>
          <td>&nbsp;</td>
          <td colspan="2"><input name="sati" type="radio" value="5"  style="border:0">-Exelente
            <input name="sati" type="radio" value="4" style="border:0">-Ótimo 
            <input name="sati" type="radio" value="3" style="border:0">-Bom 
            <input name="sati" type="radio" value="2" style="border:0">-Regular
            <input name="sati" type="radio" value="1" style="border:0">-Ruim</td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        ...
        <tr>
          <td>&nbsp;</td>
          <td>2.Comunica&ccedil;&atilde;o:</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
          <td>&nbsp;</td>
          <td colspan="2"><input name="comu" type="radio" value="5"  style="border:0">-Exelente
              <input name="comu" type="radio" value="4" style="border:0">-&Oacute;timo
              <input name="comu" type="radio" value="3" style="border:0">-Bom
              <input name="comu" type="radio" value="2" style="border:0">-Regular
              <input name="comu" type="radio" value="1" style="border:0">-Ruim</td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        ...
        <tr>
          <td>&nbsp;</td>
          <td colspan="2">3.Alinhamento com o neg&oacute;cio: </td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        ...
        <tr>
          <td>&nbsp;</td>
          <td colspan="2">
			<input name="alin" type="radio" value="5"  style="border:0">-Exelente
			<input name="alin" type="radio" value="4" style="border:0">-&Oacute;timo
			<input name="alin" type="radio" value="3" style="border:0">-Bom
			<input name="alin" type="radio" value="2" style="border:0">-Regular
			<input name="alin" type="radio" value="1" style="border:0">-Ruim
		  </td>
          <td>&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
          <td>&nbsp;</td>
          <td colspan="2">4.Resolu&ccedil;&atilde;o de problemas:</td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        ...
        <tr>
          <td>&nbsp;</td>
          <td colspan="2">
		<input name="reso" type="radio" value="5"  style="border:0">-Exelente
		<input name="reso" type="radio" value="4" style="border:0">-&Oacute;timo
		<input name="reso" type="radio" value="3" style="border:0">-Bom
		<input name="reso" type="radio" value="2" style="border:0">-Regular
		<input name="reso" type="radio" value="1" style="border:0">-Ruim
	   </td>
          <td>&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
          <td>&nbsp;</td>
          <td colspan="2">
		<input name="praz" type="radio" value="5"  style="border:0">-Exelente
		<input name="praz" type="radio" value="4" style="border:0">-&Oacute;timo
		<input name="praz" type="radio" value="3" style="border:0">-Bom
		<input name="praz" type="radio" value="2" style="border:0">-Regular
		<input name="praz" type="radio" value="1" style="border:0">-Ruim
	   </td>
          <td>&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
          <td>&nbsp;</td>
          <td colspan="2">6.Qualidade de Entrega:</td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        ...
        <tr>
          ...
          <td>Performace - </td>
          <td>
	     <input name="perf" type="radio" value="5"  style="border:0">-Exelente
	     <input name="perf" type="radio" value="4" style="border:0">-&Oacute;timo
	     <input name="perf" type="radio" value="3" style="border:0">-Bom
	     <input name="perf" type="radio" value="2" style="border:0">-Regular
	     <input name="perf" type="radio" value="1" style="border:0">-Ruim
	   </td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          ...
          <td>Estabilidade - </td>
          <td>
		<input name="esta" type="radio" value="5"  style="border:0">-Exelente
		<input name="esta" type="radio" value="4" style="border:0">-&Oacute;timo
		<input name="esta" type="radio" value="3" style="border:0">-Bom
		<input name="esta" type="radio" value="2" style="border:0">-Regular
		<input name="esta" type="radio" value="1" style="border:0">-Ruim
          </td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          ...
          <td>
		<input name="erro" type="radio" value="5"  style="border:0">-Exelente
		<input name="erro" type="radio" value="4" style="border:0">-&Oacute;timo
		<input name="erro" type="radio" value="3" style="border:0">-Bom
		<input name="erro" type="radio" value="2" style="border:0">-Regular
		<input name="erro" type="radio" value="1" style="border:0">-Ruim		  
	   </td>
          <td>&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
          <td>&nbsp;</td>
          <td colspan="2">7.Teste e homloga&ccedil;&atilde;o: </td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        ...
        <tr>
          ...
          <td>Atendimento - </td>
          <td>
		<input name="atend" type="radio" value="5"  style="border:0">-Exelente
		<input name="atend" type="radio" value="4" style="border:0">-&Oacute;timo
		<input name="atend" type="radio" value="3" style="border:0">-Bom
		<input name="atend" type="radio" value="2" style="border:0">-Regular
		<input name="atend" type="radio" value="1" style="border:0">-Ruim
	   </td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          ...
          <td>Pontualidade - </td>
          <td>
		<input name="pont" type="radio" value="5"  style="border:0">-Exelente
		<input name="pont" type="radio" value="4" style="border:0">-&Oacute;timo
		<input name="pont" type="radio" value="3" style="border:0">-Bom
		<input name="pont" type="radio" value="2" style="border:0">-Regular
		<input name="pont" type="radio" value="1" style="border:0">-Ruim
	   </td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>Disponibilidade de hambiente - </td>
          <td>
		<input name="hamb" type="radio" value="5"  style="border:0">-Exelente
		<input name="hamb" type="radio" value="4" style="border:0">-&Oacute;timo
		<input name="hamb" type="radio" value="3" style="border:0">-Bom
		<input name="hamb" type="radio" value="2" style="border:0">-Regular
		<input name="hamb" type="radio" value="1" style="border:0">-Ruim
	   </td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          ...
          <td>
		<input name="pront" type="radio" value="5"  style="border:0">-Exelente
		<input name="pront" type="radio" value="4" style="border:0">-&Oacute;timo
		<input name="pront" type="radio" value="3" style="border:0">-Bom
		<input name="pront" type="radio" value="2" style="border:0">-Regular
		<input name="pront" type="radio" value="1" style="border:0">-Ruim
	   </td>
          <td>&nbsp;<input type="hidden" name="nameprojeto" value="<?=$nameprojeto ?>"></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr>
          <td>&nbsp;</td>
          <td colspan="2" align="center"><input id="submit" type="submit" name="Submit" value="Confirmar"></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td height="5" colspan="4"></td>
        ...
        <tr align="center">
          <td colspan="4" bgcolor="#0000FF"><span style="color:#FFFFFF " > FNDE - Fundo Nacional de Desenvolvimento a Eduaca&ccedil;&atilde;o</span> </td>
        </tr>
      </table>
    </form></td>
  </tr>
