...
if($proj != ""){
	$tmpquery = " WHERE pro.id = '".$proj."' ";
	$proJustificativa = new request();
	$proJustificativa->openProjects($tmpquery);
	$Justificativa = $proJustificativa->pro_description[0];
}

$block1->openContent();

$block1->contentTitle("Justificativa");
...
$block1->openRow("on");
$block1->cellRow("$Justificativa","","","92","2","2");
$block1->closeRow();
