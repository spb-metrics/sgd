...
echo "</head>
<body $bodyCommand >";
$blockHeader1 = new block();
$blockHeader1->openTable();

//adcionado baner
include "../themes/default/baner.php"; 


echo "<table cellpadding=0 cellspacing=0 border=0 height='95%' width='760' align='center' bgcolor='#FFFFFF'>";
