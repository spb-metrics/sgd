...
include_once('../includes/library.php');
   ...
   $userDetail->openMembers($tmpquery);
	...
	headerFunction("home.php?id=$project&".session_name()."=".session_id());
	exit;
    }
...
echo "<form  method='POST' onSubmit=\"return verifica_campo();\" action='addmudanca.php?".session_name()."=".session_id()."&action=add&project=$project#filedetailsAnchor' name='addsupport' enctype='multipart/form-data' >";
	$block1 = new block();
	$block1->heading($strings["so_mudanca"]);
	 ...
	 $tmquery_unidade = "AND org.nu_seq_interno_uorg =".fixInt($projectDetail->pro_organization[0]);
	...
	echo "<table cellpadding='0' cellspacing='0' border='0'>
       ...
       echo "<table cellspacing=\"0\" width=\"90%\" border=\"0\" cellpadding=\"3\">
                 <tr align='left'><th colspan=\"2\"><strong style= color:'red';>".$strings["smudanca"]."</strong></th></tr>";
           echo "<tr><th>".$strings["titulo"]."</th><td><input size=\"32\" value=\"$tit\" style=\"width: 400px\" name=\"tit\" maxlength=\"32\" type=\"TEXT\"></td></tr>
                 <tr><th>".$strings["message"]."</th><td><textarea rows=\"3\" style=\"width: 400px; height: 50px;\" name=\"mes\" cols=\"43\">$mes</textarea></td></tr>
