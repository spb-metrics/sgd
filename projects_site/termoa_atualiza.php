...
if((!$sati=="") && (!$pront=="")){
  ...
  $tmpa = " UPDATE  ".$tableCollab["termo_aceite"]." SET relacionamento='$sati', comunica='$comu', alinha='$alin', solucao='$reso',prazo='$praz', performace='$perf' ,estabilidade='$esta' ,erros='$erro' ,atendimento='$atend' ,pontualidade='$pont',ambiente='$hamb' ,cenario='$pront',id_menber='$idSession' WHERE id_projeto='$projectSession' ";
  connectSql("$tmpa");
...
//GERA LOG
	...
	$contmail = count($usermail->mem_id);
		...
		//$enviar = "true";
		$envimail = new email();
		$envimail->enviar('Pesquisa de Satisfação Preenchida','Demanda numero '.$projectSession.' - '.$nameprojeto.' <br>Realizado apos Aceite Final realizado pelo Cliente<br>', $usermail->mem_email_work[$um]);
		...
		//exit;
           ...
           $gera->referencia($dateh,'1',$projectSession,'Pesquisa de Satisfação Preenchida',$oi);
