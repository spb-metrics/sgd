...
$cfgServers[1]['password'] 	= 'SGD';	// if you are not using adv_auth and a password is required enter a password
$cfgServers[1]['only_db'] 	= 'SGD';	// if set to a db-name, only this db is accessible
